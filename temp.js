...
let conversion = document.getElementById("res");



val.addEventListener('keyup' , () =>{
let calculo = (val.value * 9/5) +32
conversion.value=calculo;
});
...
function calc(){
    if(val.value != ""){
        let result2  =(val.value * 9/5) +32
        conversion.value=result2;
    } else{
...
// Del button
function del(){
    let result2  = val.value;
    val.value = result2.substring(0, result2.length - 1);
}
